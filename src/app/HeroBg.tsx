    ...
    <div className="hero-bg" aria-hidden="true">
      ...
      >
        ...
        {[
          ...
          { cx: 210,  cy: 750, r: 1.5, cls: "p9",  op: 0.45 },
          { cx: 390,  cy: 610, r: 2,   cls: "p10", op: 0.38 },
          { cx: 560,  cy: 480, r: 1.5, cls: "p11", op: 0.42 },
          { cx: 90,   cy: 390, r: 2,   cls: "p12", op: 0.35 },
          { cx: 720,  cy: 830, r: 2,   cls: "p13", op: 0.30 },
          { cx: 870,  cy: 700, r: 1.5, cls: "p14", op: 0.40 },
          { cx: 1010, cy: 560, r: 2,   cls: "p15", op: 0.38 },
          { cx: 1160, cy: 420, r: 1.5, cls: "p16", op: 0.45 },
          { cx: 1320, cy: 260, r: 2,   cls: "p17", op: 0.42 },
          { cx: 1420, cy: 480, r: 1.5, cls: "p18", op: 0.35 },
          { cx: 430,  cy: 150, r: 1.5, cls: "p19", op: 0.32 },
          { cx: 580,  cy: 300, r: 2,   cls: "p20", op: 0.38 },
          { cx: 820,  cy: 200, r: 1.5, cls: "p21", op: 0.30 },
          { cx: 960,  cy: 80,  r: 2,   cls: "p22", op: 0.35 },
          { cx: 1180, cy: 740, r: 1.5, cls: "p23", op: 0.32 },
          { cx: 50,   cy: 180, r: 1.5, cls: "p24", op: 0.28 },
        ].map((p) => (
          <circle
            key={p.cls}
